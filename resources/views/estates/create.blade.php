              ...
              <div class="row">
                  ...
                  <div class="col-md-2 pr-2">
                    <div class="form-group">
                      ...
                      <input type="text" name="surface" class="form-control" placeholder="Surface" value="{{ old('surface') }}">
                  ...
                  <div class="col-md-2 pr-2">
                    <div class="form-group">
                      ...
                      <input type="text" name="rooms" class="form-control" placeholder="Rooms" value="{{ old('rooms') }}">
