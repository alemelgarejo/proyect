      ...
      <div class="col-md-8">
        <div class="card">
              ...
              <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 pr-1">
                        <div class="form-group">
                            <label>{{__(" DNI")}}</label>
                                <input type="text" name="dni" class="form-control" value="{{ old('dni', auth()->user()->dni) }}">
                    ...
                    <div class="col-md-3 pr-1">
                        <div class="form-group">
                            <label>{{__(" Birthdate")}}</label>
                                <input type="text" name="birthdate" class="form-control" value="{{ old('birthdate', auth()->user()->birthdate) }}">
                  ...
                  <div class="col-md-4 pr-1">
                      <div class="form-group">
                          <label>{{__(" Comertial")}}</label>
                              <input type="text" name="comertial" class="form-control" value="{{ old('comertial', auth()->user()->comertial) }}">
          ...
          <div class="card-body">
            ...
            <div class="card-footer ">
              <button type="submit" class="btn btn-primary btn-round " style="background: #2CA8FF;">{{__('Change Password')}}</button>
            </div>
          </form>
        </div>
      </div>
