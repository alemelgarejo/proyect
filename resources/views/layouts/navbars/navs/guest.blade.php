...
<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="{{ $route }}">{{ $namePage }}</a>
        </div>
...
<style>
    .full-page-background {
        background-image: url(https://res.cloudinary.com/alemelgarejo/image/upload/v1621600109/fondo/wp7885229-lanzarote-wallpapers_gy1wr0.jpg) !important;
    }
